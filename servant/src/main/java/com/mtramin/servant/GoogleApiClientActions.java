...
class GoogleApiClientActions extends BaseClient {
    ...
    private GoogleApiClientActions(Context context, Action1<GoogleApiClient> onClientConnected, Action1<Throwable> onError, Api api) {
        super(context);
    ...
    static void create(Context context, Api api, Action1<GoogleApiClient> onClientConnected, Action1<Throwable> onError) {
        new GoogleApiClientActions(context, onClientConnected, onError, api);
    }
